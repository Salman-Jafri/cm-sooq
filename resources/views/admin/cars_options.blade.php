...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0 font-size-18">Cars Options</h4>
    </div>
  </div>
</div>
<div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="options">Options (EN)</label>
                <input class="form-control ifrequired" type="text" name="options" id="options">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="options_ar">Options (AR)</label>
                <input class="form-control ifrequired" type="text" name="options_ar" id="options_ar">
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_options">Options (EN)</label>
                <input class="form-control ifrequired" type="text" name="options" id="e_options">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_options_ar">Options (AR)</label>
                <input class="form-control ifrequired" type="text" name="options_ar" id="e_options_ar">
              </div>
            </div>
          </div>
        </form>
