...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0 font-size-18">CARS INTERIOR COLOR</h4>
    </div>
  </div>
</div>
<div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="interior_color">Color Title (EN)</label>
                <input class="form-control ifrequired" type="text" name="interior_color" id="interior_color">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="interior_color_ar">Color Title (AR)</label>
                <input class="form-control ifrequired" type="text" name="interior_color_ar" id="interior_color_ar">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_interior_color">Color Title (EN)</label>
                <input class="form-control ifrequired" type="text" name="interior_color" id="e_interior_color">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_interior_color_ar">Color Title (AR)</label>
                <input class="form-control ifrequired" type="text" name="interior_color_ar" id="e_interior_color_ar">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
