...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0 font-size-18">CARS FUEL TYPE</h4>
    </div>
  </div>
</div>
<div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="fuel_type">Fuel Type (EN)</label>
                <input class="form-control ifrequired" type="text" name="fuel_type" id="fuel_type">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="fuel_type_ar">Fuel Type (AR)</label>
                <input class="form-control ifrequired" type="text" name="fuel_type_ar" id="fuel_type_ar">
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_fuel_type">Fuel Type (EN)</label>
                <input class="form-control ifrequired" type="text" name="fuel_type" id="e_fuel_type">
              </div>
            </div>
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_fuel_type_ar">Fuel Type (AR)</label>
                <input class="form-control ifrequired" type="text" name="fuel_type_ar" id="e_fuel_type_ar">
              </div>
            </div>
          </div>
        </form>
