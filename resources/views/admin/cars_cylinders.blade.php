...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0 font-size-18">Cars Cylinders</h4>
    </div>
  </div>
</div>
<div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input class="form-control ifrequired" type="text" name="cylinders" id="cylinders">
              </div>
            </div>
          </div>
        </form>
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_cylinders">Cylinders</label>
                <input class="form-control ifrequired" type="text" name="cylinders" id="e_cylinders">
              </div>
            </div>
          </div>
        </form>
