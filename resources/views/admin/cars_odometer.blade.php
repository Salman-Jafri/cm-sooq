...
<div class="row">
  <div class="col-12">
    <div class="page-title-box d-flex align-items-center justify-content-between">
      <h4 class="mb-0 font-size-18">CARS ODOMETER</h4>
    </div>
  </div>
</div>
<div class="row">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                ...
                <input class="form-control ifrequired" type="text" name="odometer" id="odometer">
              </div>
            </div>
            <!-- <div class="col-md-12 col-sm-12 col-xs-12"><div class="form-group"><label for="odometer_ar">odometer (AR)</label><input class="form-control ifrequired" type="text" name="odometer_ar" id="odometer_ar"></div></div> -->
          </div>
        </form>
      </div>
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="form-group">
                <label for="e_odometer">Odometer</label>
                <input class="form-control ifrequired" type="text" name="odometer" id="e_odometer">
              </div>
            </div>
            <!-- <div class="col-md-12 col-sm-12 col-xs-12"><div class="form-group"><label for="e_odometer_ar">odometer (AR)</label><input class="form-control ifrequired" type="text" name="odometer_ar" id="e_odometer_ar"></div></div> -->
          </div>
        </form>
      </div>
      <div class="modal-footer">
