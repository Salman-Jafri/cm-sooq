                     ...
                     <div class="tab-menu-heading">
                        <div class="tabs-menu1">
                           <ul class="nav">
                              ...
                              <li><a href="#" class="ofnav ofc-expense-category active">Expense Category </a></li>
                     ...
                     <div class="col-12">
                        <div class="profile-log-switch">
                           <div class="media-heading">
                              <div class="row">
                                 <div class="col-6">
                                    <h3 class="card-title mb-3 font-weight-bold">Expense Category</h3>
                                 </div>
                              ...
                              <div class="col-12">
                                 <div class="wdt-100">
                                    <div id="dt_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                                       ...
                                       <div class="row">
                                          <div class="col-sm-12">
                                             <table id="dt" class="table table-bordered dt-reponsive">
                                                <thead>
                                                   <tr>
                                                      <th>#</th>
                                                      <th">Title</th>
         ...
         <div class="modal-body">
            ...
            <form id="edit-form">
               <div class="row">
                  <div class="col-md-12 col-sm-12">
                     <label for="">Title</label>
                     <input type="text" name="category_title" id="e_category_title" class="form-control" required="">
                  </div>
               </div>
            </form>
         </div>
