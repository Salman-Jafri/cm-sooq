		    ...
		    <div class="single-page">
				<div class="col-lg-5 col-xl-4 col-md-6 d-block mx-auto">
					...
					<h3 class="pb-0 mb-0">Register</h3>
						...
						<form id="registration-form" class="card-body" tabindex="500">
                            @csrf
							...
							<div class="name">
								<input type="text" name="member_contact" id="member_contact" class="isnumber" required="">
								<label>Contact</label>
							</div>
							...
							<div class="submit">
								<button type="button" class="btn btn-primary btn-block" id="btn-register">Register</button>
							</div>
...
@section('customjs')
<!-- Custom js-->
<script src="{{ url('frontend/custom_js/register.js')}}"></script>
@endsection
